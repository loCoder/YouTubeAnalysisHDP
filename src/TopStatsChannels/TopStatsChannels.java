...
public class TopStatsChannels extends Configured implements Tool {
    private static long start, end;

    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new TopStatsChannels(), args);
        System.exit(res);
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        job1.setJarByClass(TopStatsChannels.class);
        ...
        jobMid.setJarByClass(TopStatsChannels.class);
        ...
        job2.setJarByClass(TopStatsChannels.class);
        ...
        job3.setJarByClass(TopStatsChannels.class);
        ...
        job4.setJarByClass(TopStatsChannels.class);
        ...
        job5.setJarByClass(TopStatsChannels.class);
                ...
                try {
                    if ((nextLine = reader.readNext()) != null) {
                        if (nextLine.length == 5 && !(nextLine[0].trim().equals("video_id"))) {
                            ...
                            currentVal = new Text(chName + "\t" + viewCount + "\t" + dislikeCount + "\t" + commentCount);
                            context.write(currentKey, currentVal);
                        } else {
                            throw new Exception();
                        }
                ...
                try {
                    if ((nextLine = reader.readNext()) != null) {
                        if (nextLine.length == 5 && !(nextLine[0].trim().equals("video_id"))) {
                            ...
                            currentVal = new Text(chName + "\t" + viewCount + "\t" + likeCount + "\t" + commentCount);
                            context.write(currentKey, currentVal);
                        } else {
                            throw new Exception();
                        }
                ...
                try {
                    if ((nextLine = reader.readNext()) != null) {
                        if (nextLine.length == 5 && !(nextLine[0].trim().equals("video_id"))) {
                            ...
                            //viewInteger=Long.parseLong(nextLine[7].trim());
                            //views = new LongWritable(viewInteger);
                            currentVal = new Text(chName + "\t" + viewCount + "\t" + likeCount + "\t" + dislikeCount);
                            context.write(currentKey, currentVal);
                        } else {
                            throw new Exception();
                        }
